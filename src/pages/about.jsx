...
import { Contact, Footer, Socials, SwiperMain } from '../components'
		...
		<>
			<div className='about-wrapper'>
				...
				<div className='about-item first-about'>
					<span className='text-green'>Monday Academy</span> - центр современных профессий в Бухаре. Мы выпустили более 1000 человек по IT
					направлениям.
				</div>
				<div className='about-item second-about'>
					<span className='text-green'>Monday</span> - больше чем академия, это семья. Это сообщество продвинутых, где каждый уверен в своем будущем.
				</div>
			</div>
			{/* extras */}
